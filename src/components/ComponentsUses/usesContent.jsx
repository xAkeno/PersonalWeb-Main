...
const usesContent = () => {
  return (
    <div class="w-[100%] mx-auto flex flex-col space-y-8">
        <p class="text-white text-xl font-sans text-center">Laptop</p>
        <div
        ...
        <p class="text-white font-sans">Asus TUF Gaming FX505GE</p>

        <div>
            <h1
            class="text-white text-2xl font-['Franklin_Gothic_Medium','Arial_Narrow',Arial,sans-serif]"
            >
            Accessories
            </h1>
            <div class="flex gap-5 mt-3">
            <div
                class="bg-neutral-700 hover:bg-neutral-600 rounded-xl h-60 w-48 flex flex-col"
            >
                <img src={phone} alt="realme 10s" class="h-40 mx-auto" />
                <p class="px-2 text-gray-400 font-sans">
                <span class="text-white">Redmi note 10s</span><br />64gb, Black
                </p>
            </div>
            <div
                class="bg-neutral-700 hover:bg-neutral-600 rounded-xl h-60 w-48 flex flex-col"
            >
                ...
                <p class="px-2 text-gray-400 font-sans">
                <span class="text-white">HUAWEI Freebuds Pro</span>
                </p>
            </div>
            </div>
        </div>
        ...
        <div>
            <h1
            class="text-white text-2xl font-['Franklin_Gothic_Medium','Arial_Narrow',Arial,sans-serif] mb-3"
            >
            PC Hardware
            </h1>
            <div class="grid grid-cols-5 gap-5">
            <div
                class="bg-neutral-700 hover:bg-neutral-600 rounded-xl h-56 w-44 flex flex-col p-2 text-center text-white font-sans"
            >
                <img
                src={monitor}
        ...
        <div>
            ...
            <div class="grid grid-cols-5 gap-5">
                <div className="bg-neutral-700 hover:bg-neutral-600 rounded-xl h-56 w-44 flex flex-col p-2 text-center text-white font-sans">

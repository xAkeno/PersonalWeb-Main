...
const indexLoadedProject = (props) => {
  return (
    <div className='w-full h-auto border-1 border-[#383838] rounded-[15px] p-2' style={props.animate}>
        ...
        <div className="relative rounded-2xl p-1 overflow-hidden">
            <div className="rounded-xl overflow-hidden shadow-lg h-64 flex items-center justify-center p-5" style={{backgroundImage: `url(${projectwall})`,backgroundSize: "cover",backgroundPosition: "center"}}>
                <img 
                src={props.img} 
